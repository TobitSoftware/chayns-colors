...
import {darkenHexColor, getAvailableColorList, getColorFromPalette, lightenHexColor, mixHex} from "./index";
import {getRandomHexColor} from "../utils/randomColor";

test('lightenDarkenTest', () => {
    let hex = "#123456";
    let light = lightenHexColor(hex, 30);
    expect(light).not.toStrictEqual(hex);
    expect(darkenHexColor(light, 30)).toStrictEqual(hex);
    hex = "#abcdef";
    let dark = darkenHexColor(hex, 15);
